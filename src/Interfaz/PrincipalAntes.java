...
public class PrincipalAntes extends JFrame {
	...
	private static  PrincipalAntes principal;
	private JPanel panelPestannaDiagramas;
	private JScrollPane scrollPane;
	private JPanel panelDiagramas;
	private JMenu mnAsdasd;
	private JMenuItem mntmQq;
	...
	public static PrincipalAntes getInstancie () {
		if (principal == null)
	...
	private PrincipalAntes() {
		...
		mnAsdasd = new JMenu("asdasd");
		mnAsdasd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			}
		});
		mnAsdasd.setBounds(27, 11, 109, 22);
		panelSuperior.add(mnAsdasd);
		
		mntmQq = new JMenuItem("qq");
	...
	public void actualizarLienzo () {
		...
		while (iter.hasNext()) {
			...
			lienzo.add(new PanelClase(principal, claseAux)); // se crea un panel para guardar la informacion de la clase y se a�ade en el lienzo
		}
	...
	public void actualizarPanelPestannaDiagramas () { // Metodo para actualizar las pesta�as diagrama
	...
	public void actualizarColorPanelPestannaDiagrama (Diagrama diagramaAnterior) { // Metodo para actualizar el color de la pesta�a antes seleccionadad
	...
	public void crearLienzo(){
		...
		scrollPane.setViewportView(lienzo); // se a�ade al scrollpane
	...
	public void habilitarPrograma(){
		if (GestorUML.getInstancie().getProyectoSeleccionado().getDiagramaSeleccionado() != null){ // Se carg� al menos un diagrama
			crearLienzo();
	...
	public void guardarDiagrama() throws FileNotFoundException, IOException{
		ManejoDirectorios.guardarArchivo(GestorUML.getInstancie().getProyectoSeleccionado().getDiagramaSeleccionado()); // se guarda el diagrama seleccionado
	}
}
